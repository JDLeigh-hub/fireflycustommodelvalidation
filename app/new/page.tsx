...
const MODEL_OPTIONS: {
...
}[] = [
  {
    ...
    description: 'Extend a photoshoot with consistent styling and people',
    icon: Camera,
    examples: 'Brand ambassadors, editorial shoots, product-in-use',
    tip: 'Use clear, in-focus people with natural lighting and varied poses.',
    requiresKeyTerm: true,
  },
  {
    value: 'photorealistic-portraiture',
    label: 'Photorealistic Portraiture',
    description: 'Create realistic variations of an existing human likeness',
    icon: User,
    examples: 'Headshots, talent libraries, consistent character across contexts',
    tip: 'Sharp, well-lit close-ups from multiple angles work best.',
    requiresKeyTerm: true,
  },
  {
    value: 'still-life-product',
    label: 'Still Life & Product',
    description: 'Maintain visual consistency across product and food shoots',
    icon: ShoppingBag,
  ...
  },
  {
    ...
    description: 'Produce consistent illustrated characters across multiple contexts',
    icon: Laugh,
    examples: 'Brand mascots, game characters, illustrated personas',
    tip: 'Accurate anatomy, consistent rendering style, varied poses.',
    requiresKeyTerm: true,
  },
  {
    value: 'iconography-graphics',
    label: 'Iconography & Graphics',
    description: 'Expand an existing icon set or design library',
    icon: Shapes,
    examples: 'UI icon sets, brand icons, pictograms',
    tip: 'Clear, consistent stroke weight and style across all assets.',
    requiresKeyTerm: false,
  },
  {
    value: '3d-isometric',
    label: '3D & Isometric Graphics',
    description: 'Generate new graphics that maintain an established 3D visual system',
    icon: Boxes,
    examples: '3D renders, isometric illustrations, brand expression graphics',
